...
def png_to_np_array(num_images):

    #bad images_first
    #url = "https://storage.googleapis.com/road_images/8.png"
    base_url = "https://storage.googleapis.com/ini_practicum_drones/bad_roads/"
    image_list = []
    label_list = []

    for i in range(num_images):
        image_url = base_url + str(100 + i) + ".png"
        ...
        #PIL.ImageOps.expand(Image.open('images/8.png'), border=6, fill='black').save('8_border.png')
